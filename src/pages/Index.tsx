...
const SERVICES = [
  { icon: "Flame", title: "Русская парная", desc: "Жар берёзовых дров, каменная печь-каменка. Температура до 90°С. Веники из берёзы, дуба и можжевельника.", price: "от 800 ₽/час" },
  ...
  { icon: "Wind", title: "Парение с вениками", desc: "Опытный парильщик проведёт старинный обряд парения. Травяные масла, целебный пар.", price: "от 1500 ₽" },
  { icon: "Leaf", title: "Травяные сборы", desc: "Настои и отвары из трав по рецептам знахарей. Мята, чабрец, полынь, ромашка.", price: "от 300 ₽" },
  { icon: "Star", title: "Ритуальное очищение", desc: "Обряд очищения по древнеславянским традициям. Снятие усталости, восстановление сил.", price: "от 2500 ₽" },
