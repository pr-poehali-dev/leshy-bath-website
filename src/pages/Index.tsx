...
const ROOMS = [
  {
    name: "Изба Лешего",
    desc: "Просторная рубленая баня на 8 человек. Современная печь с плавной подачей пара. Лежанки из кедра с покрытием из свежего сена. Предбанник с дубовыми столами, купель, мангал.",
    features: ["до 8 чел.", "парная 75°С", "купель", "предбанник", "мангал"],
    price: "4000 ₽/час",
    img: INTERIOR_IMG,
  },
  {
    name: "Открытая зона",
    desc: "Просторная беседка с мангальной зоной в окружении леса. Дровяной мангал, длинные деревянные столы со скамьями, живой огонь. Идеально для компании под открытым небом.",
    features: ["до 20 чел.", "беседка", "мангал", "открытый воздух"],
    price: "2000 ₽ · на время аренды бани",
    img: "https://cdn.poehali.dev/projects/8ed836fa-bf72-4b56-8529-43138398c3cc/files/df6f9421-818e-44f4-b31a-c94f1aa5473d.jpg",
  },
  {
    name: "Берегиня",
